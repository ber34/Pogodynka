...
class POGODYNKA{
    ...
    const URL_IKONS ='http://www.joomla-cms.com.pl/pogoda/icons/250x250/';
	
	/* http://dev.pogodynka.net/dev/doc */
	
	/* Klucz API */
	protected $api_key = ' Api key '; /* API  */
	...
	public $icons = array(
		...
		'281' => 'drizzle.png',
		'284' => 'drizzle.png',
		'293' => 'fair-drizzle.png',
		'296' => 'fair-drizzle.png',
		'299' => 'fair-drizzle.png',
		'302' => 'fair-drizzle.png',
		'305' => 'showers.png',
		'308' => 'showers.png',
	...
	$server = $this->url_pogodynka.'/current.'.$this->type.'?key='.$this->api_key.'&';
	 ...
	 $this->html .='<img src="'.$this->url_ikons.$this->icons[$data->response->weatherCode].'" /></section>';
	 return $this->html;
	}
	...
	for($i = 0; $i < count($cities); ++$i) {
	 ...
	 $this->html .='<img src="'.$this->url_ikons.$this->icons[$data->response->city[$i]->weatherCode].'" /><br>';
	 } 
	 return $this->html;
	}
	...
	/* Zwraca pogodę na dziś w podanej lokalizacji w tym także dane astronomiczne (Wschód Słońca, Zachód Słońca, Wschód Księżyca, Zachód Księżyca)  */
	 ...
	 $this->html .='<img src="'.$this->url_ikons.$this->icons[$data->response->current->weatherCode].'" />';
	 return $this->html;
	}
	...
	public function get_weather_of_the_day_api(){
	 ...
	 $this->html .='<img src="'.$this->url_ikons.$this->icons[$data->response->weather->hourly[4]->weatherCode].'" />';
	  return $this->html;
